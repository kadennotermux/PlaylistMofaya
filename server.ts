...
async function startServer() {
  ...
  // Proxy Spotify API calls to avoid CORS and keep tokens on server if needed
  // But for simplicity in this demo, we'll let the client use the token directly 
  // or provide a few helper endpoints.
